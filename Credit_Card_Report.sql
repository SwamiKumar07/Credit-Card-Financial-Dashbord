...
select * from  cc_detail_temp;
drop table cc_details;
...
COPY cc_detail_temp
FROM 'F:\Credit_Card_Financial_Dashboard\credit_card.csv'
DELIMITER E'\t'
CSV HEADER;


-- ******************
COPY cust_detail_temp
